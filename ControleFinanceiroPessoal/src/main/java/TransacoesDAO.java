...
public class TransacoesDAO {
    ...
    public String consultarData(String data) {
        String query = "SELECT * FROM tb_registro WHERE data = ?";
    ...
    public String relatorio(String dataInicial, String dataFinal){
        // Query SQL para buscar transações no intervalo de datas
        String sql = "SELECT descricao, valor, data FROM tb_registro WHERE data BETWEEN ? AND ?";
